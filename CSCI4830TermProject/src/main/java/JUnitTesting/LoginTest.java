...
public class LoginTest {
  ...
  public void testLogin() throws Exception {
    ...
    driver.findElement(By.name("uname")).sendKeys("user99");
    ...
    driver.findElement(By.name("goToYear")).click();
    driver.findElement(By.name("goToYear")).clear();
    driver.findElement(By.name("goToYear")).sendKeys("2000");
