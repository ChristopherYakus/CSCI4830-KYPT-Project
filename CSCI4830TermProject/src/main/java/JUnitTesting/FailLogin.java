...
public class FailLogin {
  ...
  public void testFailLogin() throws Exception {
    ...
    driver.findElement(By.name("uname")).sendKeys("user10000");
    driver.findElement(By.name("pwd")).clear();
    driver.findElement(By.name("pwd")).sendKeys("Pop");
    driver.findElement(By.xpath("//input[@value='Log In']")).click();
    driver.get("http://localhost:8080/CSCI4830TermProject/LogIn");
